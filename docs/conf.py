...
htmlhelp_basename = 'AcQuantumConnectordoc'
...
man_pages = [
    (master_doc, 'acquantumconnector', 'AcQuantumConnector Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'AcQuantumConnector', 'AcQuantumConnector Documentation',
     author, 'AcQuantumConnector', 'One line description of project.',
     'Miscellaneous'),
]
